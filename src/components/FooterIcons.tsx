...
export default function FooterIcons({
  ...
  if (clickable) {
    return (
      <div className="flex gap-x-12">
        <img
          className="w-16 sm:w-72 opacity-30"
          src={pollo}
  ...
  return (
    <div className="flex gap-x-12">
      <img className="w-16 sm:w-72 opacity-30" src={pollo} />
      <img className="w-16 sm:w-72 opacity-30" src={cerdo} />
      <img className="w-16 sm:w-72 opacity-30" src={fabrica} />
    </div>
  );
}
