  ...
  return (
    ...
    >
      <div className="flex h-3/5 gap-y-6 flex-col items-center justify-center">
        ...
        <p className="w-10/12 text-5xl sm:text-5xl text-blue-700 font-semibold">{result}</p>
      </div>
      <div className="score-circle flex h-2/5 gap-y-8 bg-blue-500 justify-between">
